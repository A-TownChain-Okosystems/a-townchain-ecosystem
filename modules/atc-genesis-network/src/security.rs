...
mod tests {
    ...
    fn packet() -> Vec<u8> {
        ...
        let state = ReplicatedState { entity: NetworkEntity(9), tick: Tick(4), position_mm: [1, 2, 3], rotation_xyz_microunits: [4, 5, 6] };
