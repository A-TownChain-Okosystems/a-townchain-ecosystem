...
class ATCLexer:
    ...
    def _read_symbol(self):
        ch = self.advance()
        _line, _col = self.line, self.col  # noqa: F841
        ...
        if ch == "+":
            ...
            if self.match("."):
                if self.match("="):
                    self.add(TT.DOTDOTEQ, "..=")
                else:
                    self.add(TT.DOTDOT, "..")
            else:
                self.add(TT.DOT, ".")
        elif ch == "?":
            self.add(TT.QUESTION, "?")
        elif ch == "@":
            self.add(TT.AT, "@")
        elif ch == "#":
            self.add(TT.HASH, "#")
